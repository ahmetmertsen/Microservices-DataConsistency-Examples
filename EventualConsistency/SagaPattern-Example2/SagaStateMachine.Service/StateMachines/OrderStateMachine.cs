    ...
    public class OrderStateMachine : MassTransitStateMachine<OrderStateIstance>
    {
        ...
        public OrderStateMachine()
        {
            ...
            Event(() => OrderStartedEvent,
                orderStateIntance => orderStateIntance.CorrelateBy<long>(database => database.OrderId, @event => @event.Message.OrderId)
                    .SelectId(e => Guid.NewGuid()));

            Event(() => StockReservedEvent,
                orderStateIstance => orderStateIstance.CorrelateById(@event => @event.Message.CorrelationId));
